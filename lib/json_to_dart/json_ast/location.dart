...
class Segment extends Loc {
  ...
  bool operator ==(dynamic other) => other is Segment && line == other.line && column == other.column && offset == other.offset;
}
...
class Location {
  ...
  bool operator ==(dynamic other) => other is Location && start == other.start && end == other.end && source == other.source;
